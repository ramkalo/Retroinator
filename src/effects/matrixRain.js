...
export const matrixRainEffect = {
    ...
    params: {
        matrixRainEnabled:       { default: false },

        matrixRainText:          { default: 'You show me a capitalist, and I will show you a bloodsucker - Malcolm X' },
        matrixRainMode:          { default: 'wordOrder' },

        matrixRainInjectEnabled: { default: false },
        matrixRainInjectPercent: { default: 20, min: 0, max: 100 },
        ...
        matrixRainFont:          { default: 'monospace' },

        matrixRainX:             { default: 0, min: -50, max: 50 },
        matrixRainY:             { default: 0, min: -50, max: 50 },
