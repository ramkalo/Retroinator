export default {
    ...
    params: {
        ...
        crtCurvatureStrength:  { default: 70,   min: 0,   max: 100 },
        crtCurvatureX:         { default: 0,   min: -50, max: 50  },
        crtCurvatureY:         { default: 0,   min: -50, max: 50  },
        crtCurvatureMajor:     { default: 60,  min: 0,   max: 150 },
        crtCurvatureMinor:     { default: 60,  min: 0,   max: 150 },
        crtCurvatureAngle:     { default: 0,   min: 0,   max: 180 },
    },
    uiGroups: [
