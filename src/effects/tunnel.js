...
export const tunnelEffect = {
    ...
    params: {
        ...
        tunnelOriginColorMode:  { default: 'palette0', label: 'Origin Color', options: PALETTE_OPTIONS },
        tunnelMid0ColorMode:    { default: 'none',     label: 'Stop 1',       options: MID_COLOR_OPTIONS },
        tunnelMid0Pos:          { default: 0.14,       min: 0, max: 1, step: 0.01, label: 'Position' },
        tunnelMid1ColorMode:    { default: 'none',     label: 'Stop 2',       options: MID_COLOR_OPTIONS },
        tunnelMid1Pos:          { default: 0.29,       min: 0, max: 1, step: 0.01, label: 'Position' },
        tunnelMid2ColorMode:    { default: 'none',     label: 'Stop 3',       options: MID_COLOR_OPTIONS },
        tunnelMid2Pos:          { default: 0.43,       min: 0, max: 1, step: 0.01, label: 'Position' },
        tunnelMid3ColorMode:    { default: 'none',     label: 'Stop 4',       options: MID_COLOR_OPTIONS },
        tunnelMid3Pos:          { default: 0.57,       min: 0, max: 1, step: 0.01, label: 'Position' },
        tunnelMid4ColorMode:    { default: 'none',     label: 'Stop 5',       options: MID_COLOR_OPTIONS },
        tunnelMid4Pos:          { default: 0.71,       min: 0, max: 1, step: 0.01, label: 'Position' },
        tunnelMid5ColorMode:    { default: 'none',     label: 'Stop 6',       options: MID_COLOR_OPTIONS },
        tunnelMid5Pos:          { default: 0.86,       min: 0, max: 1, step: 0.01, label: 'Position' },
        tunnelFinalColorMode:   { default: 'palette0', label: 'Final Color',  options: PALETTE_OPTIONS },
